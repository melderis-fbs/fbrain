...
const M = {
  consultora: { id: 'id', auth_user_id: 'authUserId', nombre: 'nombre', email: 'email', rol: 'rol', cupo_maximo: 'cupoMaximo', acepta_nuevos: 'aceptaNuevos', activa: 'activa', color: 'color', mano_levantada_at: 'manoLevantadaAt', mano_levantada_nota: 'manoLevantadaNota', sesiones_back_to_back: 'sesionesBackToBack' },
  cliente: { id: 'id', nombre: 'nombre', email: 'email', telefono: 'telefono', programa: 'programa', fecha_alta: 'fechaAlta', fecha_alta_provisional: 'fechaAltaProvisional', fecha_fin_prevista: 'fechaFinPrevista', plan_pago: 'planPago', tiene_garantia: 'tieneGarantia', fuente: 'fuente', consultora_id: 'consultoraId', estado: 'estado', drive_folder_id: 'driveFolderId', horas_reales_semana: 'horasRealesSemana', dias_gracia_pago: 'diasGraciaPago', nivel_desalineado: 'nivelDesalineado', nivel_vendido: 'nivelVendido', closer: 'closer', setter: 'setter', monto_total: 'montoTotal', cantidad_cuotas: 'cantidadCuotas', estado_deuda: 'estadoDeuda', notas: 'notas', renovaciones: 'renovaciones', ultima_renovacion: 'ultimaRenovacion' },
