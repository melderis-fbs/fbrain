...
const M = {
  ...
  cliente: { id: 'id', nombre: 'nombre', email: 'email', telefono: 'telefono', programa: 'programa', fecha_alta: 'fechaAlta', fecha_fin_prevista: 'fechaFinPrevista', plan_pago: 'planPago', tiene_garantia: 'tieneGarantia', fuente: 'fuente', consultora_id: 'consultoraId', estado: 'estado', drive_folder_id: 'driveFolderId', horas_reales_semana: 'horasRealesSemana', dias_gracia_pago: 'diasGraciaPago', nivel_desalineado: 'nivelDesalineado', nivel_vendido: 'nivelVendido', closer: 'closer', setter: 'setter', monto_total: 'montoTotal', cantidad_cuotas: 'cantidadCuotas', estado_deuda: 'estadoDeuda', notas: 'notas' },
